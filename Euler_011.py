...
# Lines
for o in range(size - (length-1)):
    for i in range(size):
        prod = 1
        for x in range(length):
            prod *= numbers[(o + x, i)]
            print(numbers[(o + x, i)], end=' ')
...
for o in range(size - (length-1)):
    for i in range(size - (length-1)):
        prod = 1
        for x in range(length):
            prod *= numbers[(o + x, i + x)]
            print(numbers[(o + x, i + x)], end=' ')
        max_product = max(max_product, prod)
        print(f' , ', end='')
    print()
print()
